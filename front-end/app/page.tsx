      ...
      <div className="relative z-10 w-full max-w-xl mx-auto text-center">
        ...
        <div className="mb-10 sm:mb-12">
          ...
          <h1 className="text-4xl sm:text-6xl md:text-7xl font-bold text-white dark:text-white tracking-tight transition-colors duration-500">
            <span className="bg-gradient-to-r from-blue-400 via-blue-500 to-cyan-400 dark:from-blue-400 dark:via-blue-500 dark:to-cyan-400 bg-clip-text text-transparent drop-shadow-2xl glow-text">
              FROXY
            </span>
          </h1>
        </div>
            ...
            >
              ...
              <div className="flex items-center">
                ...
                <input
                  ...
                  className="w-full py-4 sm:py-5 pl-16 sm:pl-20 pr-12 sm:pr-16 bg-transparent text-white dark:text-white placeholder-gray-400 dark:placeholder-gray-400 text-base sm:text-lg focus:outline-none transition-colors duration-500 font-mono"
                />
                <button
                  type="submit"
